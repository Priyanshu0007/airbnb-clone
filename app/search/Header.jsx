...
const Header = () => {
  ...
  return (
    <header className='flex border-b bg-white z-50 fixed w-full'>
        ...
        {isExpanded?<SearchBar></SearchBar>: <button onClick={toggleExpanded} className={searchContainerClasses}>
            <div className="input flex items-center border-r px-4"><p>Anywhere</p></div>
            <div className="input flex items-center border-r px-4"><p>Any Date</p></div>
            <div className="input flex items-center border-r px-4"><p>Add Guests</p></div>
